...
const Nav = () => {
 ...
 "
        ...
        <div className="w-10 h-10 bg-gradient-to-bl from-white/50 to-white/10 rounded-full flex items-center justify-center backdrop-blur-3xl text-white p-2 mt-5">
